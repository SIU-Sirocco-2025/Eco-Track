...
Khi sử dụng lại dữ liệu, ngoài việc ghi công Eco‑Track theo CC BY 4.0, bạn phải **tuân thủ đầy đủ yêu cầu ghi công và các điều khoản** của từng nhà cung cấp upstream (ví dụ: OpenAQ, OSM/ODbL, v.v.), như được tóm tắt ở mục 3 và trên trang giấy phép/chính sách của họ.



## 1) Phạm vi dữ liệu áp dụng

Giấy phép CC BY 4.0 áp dụng cho dữ liệu do hệ thống Eco‑Track xử lý/xuất bản một cách công khai, bao gồm:
...
Tóm lại: dữ liệu do Eco‑Track tổng hợp/xử lý được cấp phép CC BY 4.0; dữ liệu gốc từ bên thứ ba vẫn chịu sự điều chỉnh của giấy phép gốc của họ. Bạn phải đảm bảo vừa đáp ứng CC BY 4.0 vừa đáp ứng điều kiện của nguồn gốc dữ liệu (nếu có).
...
- Bạn có thể sử dụng/tái phân phối/chỉnh sửa dữ liệu theo CC BY 4.0.
- Bạn phải:
